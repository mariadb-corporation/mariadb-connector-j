...
|alwaysAutoGeneratedKeys|
By default the use of [Statement.executeUpdate](https://docs.oracle.com/javase/8/docs/api/java/sql/Statement.html#executeUpdate-java.lang.String-) will not retrieve insert Id's data.
[Statement.getGeneratedKeys()](https://docs.oracle.com/javase/8/docs/api/java/sql/Statement.html#getGeneratedKeys--) command with throws an exception. 
Statement has additionnal parameters to indicate that id's must be retrieved : like [Statement.executeUpdate(String sql,
int autoGeneratedKeys](https://docs.oracle.com/javase/8/docs/api/java/sql/Statement.html#executeUpdate-java.lang.String-int-).<br/> 
When option alwaysAutoGeneratedKeys is set to true, insert id's will be retrieved for each query even if no autoGeneratedKeys is given, or [Statement.NO_GENERATED_KEYS](https://docs.oracle.com/javase/8/docs/api/java/sql/Statement.html#NO_GENERATED_KEYS) is set.<br/> 
