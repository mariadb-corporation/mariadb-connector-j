...
|alwaysAutoGeneratedKeys|JDBC statement permit to retrieve last query insert Id's by the [Statement.getGeneratedKeys](https://docs.oracle.com/javase/8/docs/api/java/sql/Statement.html#getGeneratedKeys--) command. Driver retrieve those information only if [Statement.RETURN_GENERATED_KEYS](https://docs.oracle.com/javase/8/docs/api/java/sql/Statement.html#RETURN_GENERATED_KEYS) is precised when inserting data (method example [executeUpdate](https://docs.oracle.com/javase/8/docs/api/java/sql/Statement.html#executeUpdate-java.lang.String-int-)). Set to true, driver will always return generated keys when possible.<br/>*Default: false. Since 1.3.0*|
