...
import org.tidb.jdbc.message.client.ClosePreparePacket;
import org.tidb.jdbc.message.client.HandshakeResponse;
import org.tidb.jdbc.message.client.QueryPacket;
import org.tidb.jdbc.message.client.QuitPacket;
...
public class StandardClient implements Client, AutoCloseable {
  ...
  public List<Completion> execute(ClientMessage message, Statement stmt, boolean canRedo)
      throws SQLException {
    return execute(
        message,
        stmt,
