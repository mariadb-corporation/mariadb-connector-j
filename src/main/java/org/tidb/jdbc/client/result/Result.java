...
import org.tidb.jdbc.codec.RowDecoder;
import org.tidb.jdbc.codec.TextRowDecoder;
...
public abstract class Result implements ResultSet, Completion {
  ...
  /** packet reader */
  protected final org.tidb.jdbc.client.socket.Reader reader;
  ...
  @Override
  public org.tidb.jdbc.client.result.ResultSetMetaData getMetaData() {
