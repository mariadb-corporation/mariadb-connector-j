...
package org.tidb.jdbc.client.result;
...
import org.tidb.jdbc.codec.BinaryRowDecoder;
...
public class UpdatableResult extends CompleteResult {
  ...
  public UpdatableResult(
      ...
      long maxRows,
      Column[] metadataList,
      org.tidb.jdbc.client.socket.Reader reader,
      Context context,
      int resultSetType,
  ...
  public void updateNull(int columnIndex) throws SQLException {
    ...
    parameters.set(columnIndex - 1, org.tidb.jdbc.codec.Parameter.NULL_PARAMETER);
  }

  @Override
  public void updateBoolean(int columnIndex, boolean x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(BooleanCodec.INSTANCE, x));
  }

  @Override
  public void updateByte(int columnIndex, byte x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(ByteCodec.INSTANCE, x));
  }

  @Override
  public void updateShort(int columnIndex, short x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(ShortCodec.INSTANCE, x));
  }

  @Override
  public void updateInt(int columnIndex, int x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(IntCodec.INSTANCE, x));
  }

  @Override
  public void updateLong(int columnIndex, long x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(LongCodec.INSTANCE, x));
  }

  @Override
  public void updateFloat(int columnIndex, float x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(FloatCodec.INSTANCE, x));
  }

  @Override
  public void updateDouble(int columnIndex, double x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(DoubleCodec.INSTANCE, x));
  }
  ...
  public void updateBigDecimal(int columnIndex, BigDecimal x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(
        columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(BigDecimalCodec.INSTANCE, x));
  }

  @Override
  public void updateString(int columnIndex, String x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(StringCodec.INSTANCE, x));
  }
  ...
  public void updateBytes(int columnIndex, byte[] x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(
        columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(ByteArrayCodec.INSTANCE, x));
  }

  @Override
  public void updateDate(int columnIndex, Date x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(DateCodec.INSTANCE, x));
  }

  @Override
  public void updateTime(int columnIndex, Time x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(TimeCodec.INSTANCE, x));
  }
  ...
  public void updateTimestamp(int columnIndex, Timestamp x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(
        columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(TimestampCodec.INSTANCE, x));
  }
  ...
  public void updateCharacterStream(int columnIndex, Reader x, int length) throws SQLException {
    ...
    parameters.set(
        columnIndex - 1,
        new org.tidb.jdbc.codec.Parameter<>(ReaderCodec.INSTANCE, x, (long) length));
  }
        ...
        for (int pos = 0; pos < metadataList.length; pos++) {
          ...
          if (param != null) {
            ...
            ((BasePreparedStatement) insertPreparedStatement)
                .setParameter(paramPos++, org.tidb.jdbc.codec.Parameter.NULL_PARAMETER);
          }
        }
  ...
  public void updateBlob(int columnIndex, Blob x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(BlobCodec.INSTANCE, x));
  }
  ...
  public void updateClob(int columnIndex, Clob x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(ClobCodec.INSTANCE, x));
  }
  ...
  public void updateAsciiStream(int columnIndex, InputStream x, long length) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(
        columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(StreamCodec.INSTANCE, x, length));
  }
  ...
  public void updateCharacterStream(int columnIndex, Reader x, long length) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(
        columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(ReaderCodec.INSTANCE, x, length));
  }
  ...
  public void updateAsciiStream(int columnIndex, InputStream x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(StreamCodec.INSTANCE, x));
  }
  ...
  public void updateCharacterStream(int columnIndex, Reader x) throws SQLException {
    checkUpdatable(columnIndex);
    parameters.set(columnIndex - 1, new org.tidb.jdbc.codec.Parameter<>(ReaderCodec.INSTANCE, x));
  }
    ...
    for (Codec<?> codec : context.getConf().codecs()) {
      if (codec.canEncode(x)) {
        org.tidb.jdbc.codec.Parameter p =
            new org.tidb.jdbc.codec.Parameter(codec, x, scaleOrLength);
