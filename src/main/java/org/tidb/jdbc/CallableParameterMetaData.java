...
public class CallableParameterMetaData implements java.sql.ParameterMetaData {
  ...
  public int isNullable(int index) throws SQLException {
    setIndex(index);
    return org.tidb.jdbc.ParameterMetaData.parameterNullableUnknown;
  }
  ...
  public int getParameterMode(int index) throws SQLException {
    setIndex(index);
    if (isFunction) return org.tidb.jdbc.ParameterMetaData.parameterModeOut;
    String str = rs.getString("PARAMETER_MODE");
    switch (str) {
      case "IN":
        return org.tidb.jdbc.ParameterMetaData.parameterModeIn;
      case "OUT":
        return org.tidb.jdbc.ParameterMetaData.parameterModeOut;
      case "INOUT":
        return org.tidb.jdbc.ParameterMetaData.parameterModeInOut;
      default:
        return org.tidb.jdbc.ParameterMetaData.parameterModeUnknown;
    }
  }
