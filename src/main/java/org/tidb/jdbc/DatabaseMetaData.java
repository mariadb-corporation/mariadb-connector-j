...
import org.tidb.jdbc.util.constants.ColumnFlags;
import org.tidb.jdbc.util.constants.ServerStatus;

/** TiDB Database metadata */
public class DatabaseMetaData implements java.sql.DatabaseMetaData {

  /** TiDB driver name */
  public static final String DRIVER_NAME = "TiDB Connector/J";
  ...
  private ResultSet getImportedKeys(
      String tableDef, String tableName, String catalog, Connection connection)
      throws ParseException {
    String[] columnNames = {
  ...
  public String getSQLKeywords() {
    return "ACCESSIBLE,ANALYZE,ASENSITIVE,BEFORE,BIGINT,BINARY,BLOB,CALL,CHANGE,CONDITION,DATABASE,DATABASES,"
        ...
        + "SQLEXCEPTION,SSL,STARTING,STRAIGHT_JOIN,TERMINATED,TINYBLOB,TINYINT,TINYTEXT,UNDO,UNLOCK,"
