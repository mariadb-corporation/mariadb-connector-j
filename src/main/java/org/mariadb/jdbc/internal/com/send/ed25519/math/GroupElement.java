...
public class GroupElement implements Serializable {
    ...
    /**
     * Precomputed table for {@link #doubleScalarMultiplyVariableTime(org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement, byte[], byte[])},
     * filled if necessary.
     * <p>
     * Variable is package private only so that tests run.
     */
    ...
    public static org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement p2(
            ...
            final FieldElement Y,
            final FieldElement Z) {
        return new org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement(curve, Representation.P2, X, Y, Z, null);
    }
    ...
    public static org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement p3(
            ...
            final FieldElement Z,
            final FieldElement T) {
        return new org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement(curve, Representation.P3, X, Y, Z, T);
    }
    ...
    public static org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement p1p1(
            ...
            final FieldElement Z,
            final FieldElement T) {
        return new org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement(curve, Representation.P1P1, X, Y, Z, T);
    }
    ...
    public static org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement precomp(
        ...
        return new org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement(curve, Representation.PRECOMP, ypx, ymx, xy2d, null);
    }
    ...
    public static org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement cached(
        ...
        return new org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement(curve, Representation.CACHED, YpX, YmX, Z, T2d);
    }
     ...
     */
    private org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement toRep(final Representation repr) {
        switch (this.repr) {
            case P2:
                switch (repr) {
                    case P2:
     ...
     * and {@link #doubleScalarMultiplyVariableTime(org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement, byte[], byte[])}.
     *
     ...
     */
    private org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement madd(org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement q) {
     ...
     * @return the P1P1 representation of the result.
     */
    private org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement msub(org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement q) {
        if (this.repr != Representation.P3)
            throw new UnsupportedOperationException();
        if (q.repr != Representation.PRECOMP)
            throw new IllegalArgumentException();
     ...
     * @return the P1P1 representation of the result.
     */
    public org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement add(org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement q) {
        if (this.repr != Representation.P3)
            throw new UnsupportedOperationException();
     ...
     * @return the P1P1 representation of the result.
     */
    public org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement sub(org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement q) {
        if (this.repr != Representation.P3)
            throw new UnsupportedOperationException();
        if (q.repr != Representation.CACHED)
            throw new IllegalArgumentException();
     ...
     */
    org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement cmov(final org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement u, final int b) {
    ...
    org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement select(final int pos, final int b) {
        ...
        // 16^i |r_i| B
        final org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement t = this.curve.getZero(Representation.PRECOMP)
        ...
        // -16^i |r_i| B
        final org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement tminus = precomp(curve, t.Y, t.X, t.Z.negate());
        // 16^i r_i B
     ...
     * @return the GroupElement
     */
    public org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement scalarMultiply(final byte[] a) {
        org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement t;
        int i;

        final byte[] e = toRadix16(a);

        org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement h = this.curve.getZero(Representation.P3);
        synchronized (this) {
     ...
     * @return the GroupElement
     */
    public org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement doubleScalarMultiplyVariableTime(final org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement A, final byte[] a, final byte[] b) {
        // TODO-CR BR: A check that this is the base point is needed.
        final byte[] aslide = slide(a);
        final byte[] bslide = slide(b);

        org.mariadb.jdbc.internal.com.send.ed25519.math.GroupElement r = this.curve.getZero(Representation.P2);
