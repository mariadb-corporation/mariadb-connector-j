...
/** MariaDB Driver that doesn't register itself to DriverManager */
public class NonRegisteringDriver implements java.sql.Driver {
   ...
   */
  public final Connection connect(final String url, final Properties props) throws SQLException {
  ...
  public final DriverPropertyInfo[] getPropertyInfo(String url, Properties info)
    ...
    try (InputStream inputStream =
        NonRegisteringDriver.class.getClassLoader().getResourceAsStream("driver.properties")) {
  ...
  public final java.util.logging.Logger getParentLogger() throws SQLFeatureNotSupportedException {
