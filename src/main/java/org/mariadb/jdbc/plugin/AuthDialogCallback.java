...
/**
 * Typical use: a JDBC client registers an implementation that surfaces {@code prompt} in its UI and
...
public interface AuthDialogCallback {
   ...
   * @return the user's answer, or {@code null} to fall through to the legacy {@code passwordN} URL
   *     options
   */
