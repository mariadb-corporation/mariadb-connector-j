...
public class IntCodec implements Codec<Integer> {
  ...
  @Override
  public void encodeText(Writer encoder, Context context, Integer value, Calendar cal, Long maxLen)
      throws IOException {
    encoder.writeAscii(value.toString());
  }

  @Override
  public int getApproximateTextProtocolLength(Integer value, Long length) {
