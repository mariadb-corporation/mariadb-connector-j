...
public class ClientPreparedStatement extends BasePreparedStatement {
   ...
   * @param autoGeneratedKeys must the command return automatically generated keys?
  ...
  public ClientPreparedStatement(
    ...
    parameters = new ParameterList(parser.paramCount());
  }
  ...
  protected BatchTypeState executeInternalPreparedBatch() throws SQLException {
    ...
    if (possibleLoadLocal) {
      ...
      // the individual results, since affected rows cannot be guessed
      ...
      if (canUseBulk
        ...
        return BatchTypeState.Bulk;
          ...
          && !parser.paramPositions().isEmpty()
          && parser.valuesBracketPositions() != null
          && autoGeneratedKeys == Statement.NO_GENERATED_KEYS
          && batchParameters.size() > 1) {
        // values rewritten in one query :
        // INSERT INTO X(a,b) VALUES (1,2),(3,4), ...
        executeBatchRewrite();
        return BatchTypeState.Rewrite;
      } else {
  ...
  private void executeBatchRewrite() throws SQLException {
    try {
      results =
          con.getClient()
              .execute(
                  new QueryWithParametersRewritePacket(preSqlCmd(), parser, batchParameters),
                  this,
                  0,
                  maxRows,
                  ResultSet.CONCUR_READ_ONLY,
  ...
  public java.sql.ParameterMetaData getParameterMetaData() throws SQLException {
    ...
    if (prepareResult == null) {
      try (ClosableLock ignore = lock.closeableLock()) {
        ...
        return new SimpleParameterMetaData(exceptionFactory(), parser.paramCount());
      }
    }
