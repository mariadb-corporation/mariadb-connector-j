 ...
 * will not work.
 */
public class MariaDbNewCallableStatement implements CallableStatement {
    /**
     ...
     */
    public MariaDbNewCallableStatement(MariaDbConnection connection, String query) throws SQLException {
        con = connection;
