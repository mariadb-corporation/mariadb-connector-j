...
class DrizzleCalllableParameterMetaData implements ParameterMetaData {
    ...
    public DrizzleCalllableParameterMetaData(CallParameter[] params, Connection con, String name, boolean  isFunction) {
        this.params = params;
        this.con = con;
        this.name = name;
 ...
 * will not work.
 */
public class  DrizzleCallableStatement implements CallableStatement
{
    /**
     *  Database connection
     */
     ...
     */
    CallParameter params[];
    DrizzleCalllableParameterMetaData parameterMetadata;
    int parametersCount;
    ...
    public DrizzleCallableStatement(Connection connection, String query) throws SQLException{
        con = connection;
        ...
        parameterMetadata = new DrizzleCalllableParameterMetaData(params, con, procedureName, isFunction);
    }
