...
public class MySQLRowPacket {
    ...
    public MySQLRowPacket(RawPacket rawPacket, List<ColumnInformation> columnInformation) {
        ...
        for (ColumnInformation currentColumn : columnInformation) {
            ...
            ValueObject dvo = new MySQLValueObject(leb.getBytes(), currentColumn.getType());
            columns.add(dvo);
