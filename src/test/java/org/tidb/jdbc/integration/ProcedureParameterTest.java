...
import org.tidb.jdbc.CallableParameterMetaData;
...
public class ProcedureParameterTest extends Common {
  ...
  public void basicProcedure() throws SQLException {
    ...
    try (CallableStatement callableStatement =
      ...
      assertNotNull(meta.unwrap(CallableParameterMetaData.class));
      ...
      assertTrue(meta.isWrapperFor(CallableParameterMetaData.class));
