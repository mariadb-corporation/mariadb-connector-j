...
public class PrepareThresholdTest extends Common {
  ...
  public static void beforeAll2() throws SQLException {
    ...
    Statement stmt = sharedConn.createStatement();
    stmt.execute(
        "CREATE TABLE prepareThresholdTest (id int not null primary key auto_increment, value"
            + " varchar(100))");
  ...
  public void testPrepareThresholdDefault() throws SQLException {
    ...
    try (Connection con = createCon("&cachePrepStmts=true&prepStmtCacheSize=10")) {
  ...
  public void testPrepareThresholdWithoutCache() throws SQLException {
    ...
    try (Connection con =
        createCon("&useServerPrepStmts=true&cachePrepStmts=false&prepareThreshold=5")) {
      String sql = "SELECT * FROM prepareThresholdTest WHERE id = ?";
